            ...
            <div style={{ display: 'flex', gap: '16px', justifyContent: 'center' }}>
              ...
              >
                <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path d="M19.365 9.863c.349 0 .63.285.63.631 0 .345-.281.63-.63.63H17.61v1.125h1.755c.349 0 .63.283.63.63 0 .344-.281.629-.63.629h-2.386c-.345 0-.627-.285-.627-.629V8.108c0-.345.282-.63.63-.63h2.386c.346 0 .627.285.627.63 0 .349-.281.63-.63.63H17.61v1.125h1.755zM15.81 10.43V8.108c0-.345-.285-.63-.63-.63-.346 0-.63.285-.63.63v4.137c0 .346.284.63.63.63h.004l2.427-3.136v3.136c0 .346.284.63.63.63.346 0 .63-.285.63-.63V8.108c0-.345-.284-.63-.63-.63-.346 0-.63.285-.63.63v3.136l-2.427-3.136h-.004zM11.978 12.875c0 .346-.285.63-.63.63-.346 0-.63-.285-.63-.63V8.108c0-.345.284-.63.63-.63.346 0 .63.285.63.63v4.767zm-3.08-3.012H7.143V8.108c0-.345-.285-.63-.63-.63-.346 0-.63.285-.63.63v4.137c0 .346.285.63.63.63h2.386c.345 0 .63-.285.63-.63 0-.346-.285-.63-.63-.63zM24 10.224c0-4.321-4.757-7.838-10.603-7.838-5.842 0-10.6 3.517-10.6 7.838 0 3.861 3.805 7.155 8.783 7.747.34.072.8.219.923.504.111.261.071.666.035.937l-.142.848c-.044.267-.206 1.01.884.546 1.09-.464 5.892-3.468 7.837-5.795C23.003 13.565 24 11.97 24 10.224z" />
                </svg>
                <span>LINE 登入</span>
              </button>
